...
class Extension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        ...
        # CRITICAL FIX: Initialize all attributes immediately
    ...
    def _on_window(self, visible):
        if self._window.visible:
            ...
            # NOTE: We now call the UIBuilder's menu callback here, after the UI is built
            # If the user opens the UI via the toolbar, this is the main entry point.
    ...
    def _menu_callback(self):
        # **[FIXED]** Only toggles visibility. The logic runs via _on_window callback.
